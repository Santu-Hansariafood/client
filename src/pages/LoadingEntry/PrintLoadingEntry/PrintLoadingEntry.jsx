...
const PrintLoadingEntry = async (data) => {
  ...
  try {
    ...
    // Ship To (Consignee) uses Consignee data FROM SAUDA API (single source)
    let shipToAddress = 
    ...
    let shipToMobile =
      ...
      sauda.shipToMobile ||
      sauda.consignee?.phone ||
      sauda.consignee?.mobile ||
      sauda.shipTo?.phone ||
      sauda.shipTo?.mobile ||
      data.consigneeMobile ||
      "N/A";
    ...
    // Buyer Account uses Buyer data FROM SAUDA API (single source)
    const buyerCompany = 
      sauda.buyerCompany ||
      sauda.buyerName ||
      data.buyerCompany ||
