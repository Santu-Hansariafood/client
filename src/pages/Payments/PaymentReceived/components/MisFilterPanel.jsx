import { FaFilter, FaPrint, FaPlus, FaUndo, FaEnvelope } from "react-icons/fa";
      ...
      <div className="px-4 sm:px-6 py-5 sm:py-6 border-b border-slate-100 bg-gradient-to-br from-slate-50 via-white to-blue-50 flex flex-col xl:flex-row xl:items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-amber-600 hover:from-emerald-700 hover:to-amber-700 text-white text-xs font-semibold uppercase tracking-wide shadow-lg shadow-emerald-600/20 transition-all duration-200"
          >
