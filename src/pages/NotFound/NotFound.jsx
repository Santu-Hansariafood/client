...
const NotFound = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-yellow-100 px-6 text-center">
      <div className="bg-amber-500 text-white px-4 py-2 rounded-md mb-4">
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 max-w-md w-full text-center">
        ...
        <div className="flex space-x-4">
          <button
            className="flex items-center bg-amber-500 text-white px-4 py-2 rounded-md hover:bg-amber-600 transition"
            onClick={() => navigate(-1)}
          >
