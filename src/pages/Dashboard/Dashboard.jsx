              ...
              <div className="relative bg-white/40 backdrop-blur-3xl rounded-[3.5rem] p-10 sm:p-14 border border-white/60 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.05)] animate-fade-in-up delay-200">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                  <div className="space-y-2">
                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-emerald-50 text-emerald-600 border border-emerald-100 text-[10px] font-black uppercase tracking-widest">
                      Analytics Dashboard
                    </div>
                  ...
                  <div className="flex items-center gap-3 px-5 py-3 rounded-2xl bg-white/50 border border-white/80 shadow-sm">
                    ...
                    <span className="text-[11px] font-black text-slate-700 uppercase tracking-[0.2em]">
                      Real-time Live Feed
                    </span>
                  </div>
                </div>
